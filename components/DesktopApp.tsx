                          ...
                          <div className="-ml-1 flex items-center gap-2">
                            ...
                            {point.title && (
                              <JustifiedText
                                ...
                                html={linkLawText(extraPointTitleHtml(point), pageQuestion.disabledAutoLinks ?? [])}
                                onClick={lawClick}
                              />
                            )}
                          </div>
        ...
        <div className="lex-editor-body">
          ...
          <div className="mt-5">
            ...
            <div className="space-y-3">
                ...
                <div key={point.editorKey} className="lex-extra-point rounded-2xl border border-[#e5e5e1] p-4">
                    <div className="flex gap-2">
                    <input
  ...
  function MoveChapterSheet({
    ...
    return (
      <div onClick={onClose} className="fixed inset-0 z-50 flex items-end bg-black/25">
        <div
          onClick={(e) => e.stopPropagation()}
          className="mx-auto max-h-[75svh] w-full max-w-[520px] overflow-y-auto rounded-t-[24px] bg-white px-5 pt-5 pb-[calc(20px+env(safe-area-inset-bottom))]"
        >

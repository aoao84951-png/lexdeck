...
export type StudyQuestion = { id: string; subjectId: string; chapterId: string; textHtml: string; explanationHtml: string; answer: "O" | "X"; memorized: boolean; importanceStars?: number; favorite?: boolean; extraPoints?: {category: string; title: string; titleHtml?: string; descriptionHtml: string}[] };

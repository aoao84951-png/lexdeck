export type StudyEvidence = { id: string; kind: "law" | "case"; html: string };
...
export type StudyQuestion = { evidence?: StudyEvidence[]; id: string; subjectId: string; chapterId: string; textHtml: string; explanationHtml: string; answer: "O" | "X"; memorized: boolean; importanceStars?: number; favorite?: boolean; extraPoints?: {category: string; title: string; titleHtml?: string; descriptionHtml: string}[] };

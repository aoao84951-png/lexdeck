export type StudySubject = { id: string; name: string; color: string };
export type StudyChapter = { id: string; subjectId: string; parentId: string | null; title: string; type?: "folder" | "chapter"; color?: string };
